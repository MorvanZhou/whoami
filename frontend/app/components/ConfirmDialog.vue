        ...
        >
          ...
          >
            <div class="p-6">
              ...
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1 min-w-0">
                  ...
                  <p class="text-sm text-th-text-s mt-1">{{ message }}</p>
                </div>
              </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 px-6 py-4 bg-th-bg/50 border-t border-th-text/[var(--color-border-opacity)]">
              <button
                class="px-4 py-2 rounded-lg text-sm font-medium text-th-text-s hover:text-th-text hover:bg-th-bg-t transition-colors"
                @click="emit('cancel')"
              >
                {{ cancelText }}
              </button>
