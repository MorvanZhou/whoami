...
<template>
  <div class="flex flex-col gap-3 w-full">
    ...
    <!-- Microsoft -->
    <button
      class="flex items-center justify-center gap-3 w-full px-5 py-3 rounded-xl bg-white border border-gray-200 text-gray-800 font-medium hover:bg-gray-50 dark:bg-[#2f2f2f] dark:border-white/10 dark:text-white dark:hover:bg-[#3a3a3a] transition-all duration-200 group"
      @click="oauthLogin('microsoft')"
    >
      <svg class="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 21 21">
